      ...
      <div className="bg-gradient-to-b from-[#101212] relative to-[#08201D]">
            ...
            <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 relative z-20">
                <div className="flex flex-col items-center justify-center max-w-xl mx-auto text-center">
                    <h1 className="text-4xl font-bold sm:text-6xl">
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-300 to-white">Eating well has never been easier</span>
                    </h1>
                    <p className="mt-5 text-base text-white sm:text-xl">With our diets, well-being is within your reach.</p>

                    {!session && <Button variant={ButtonVariant.discord} className='mt-7' onClick={() => signIn('auth0')}>Sign In</Button>}
                    {session && <Link href={'/diet'}><Button variant={ButtonVariant.discord} className='mt-7'>Get diet</Button></Link>}
                    ...
                    <div className="grid grid-cols-1 px-20 mt-12 text-left gap-x-12 gap-y-8 sm:grid-cols-3 sm:px-0">
                        <div className="flex items-center">
                            ...
                            <p className="ml-3 text-sm text-white">More than 500 people registered</p>
                        </div>
                        ...
                        <div className="flex items-center">
                            ...
                            <p className="ml-3 text-sm text-white">Fast diets by mail</p>
                        </div>

                        <div className="flex items-center">
                            <svg className="flex-shrink-0" width="20" height="24" viewBox="0 0 20 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M17 11H3C1.89543 11 1 11.8954 1 13V21C1 22.1046 1.89543 23 3 23H17C18.1046 23 19 22.1046 19 21V13C19 11.8954 18.1046 11 17 11Z" stroke="white" strokeWidth="1.5"
                                    strokeMiterlimit="10"
                                    strokeLinecap="round"
                                    strokeLinejoin="round" />
                                <path d="M10 19C11.1046 19 12 18.1046 12 17C12 15.8954 11.1046 15 10 15C8.89543 15 8 15.8954 8 17C8 18.1046 8.89543 19 10 19Z" stroke="#28CC9D" strokeWidth="1.5"
                                    strokeMiterlimit="10"
                                    strokeLinecap="round"
                                    strokeLinejoin="round" />
                                <path
        ...
        <section className='relative lg:h-min pt-14 pb-10 sm:pt-32 sm:pb-16 lg:pb-24'>
          <div className='flex flex-col items-center'>
            <h3 className='text-white text-3xl font-bold'>How to use Eat Fix?</h3>
          </div>
          <div>

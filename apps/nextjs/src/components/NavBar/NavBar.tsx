            ...
            <div className="px-4 mx-auto sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-16 lg:h-20">
                    ...
                    <div className="hidden lg:flex lg:items-center lg:justify-center lg:space-x-10">
                        ...
                        {/* {session?.user && router.pathname === '/' ? <Link href='/diet' title="" className="text-base text-white transition-all duration-200 hover:text-opacity-80"> Get diet! </Link> :<Link href="/" title="" className="text-base text-white transition-all duration-200 hover:text-opacity-80"> Home </Link> } */}
                    </div>
